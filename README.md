...
> Python client SDK for interacting with the core inference API - part of the [FluxRelay](https://github.com/FluxRelay) open-source ecosystem.
...
The `sdk` package provides the Python interface for integrating with FluxRelay's infrastructure, designed for ease of use in both scripts and production services.
...
```bash
git clone https://github.com/FluxRelay/sdk
cd sdk
pip install -e .
```
...
- **GitHub Issues:** [github.com/FluxRelay/issues](https://github.com/FluxRelay)
- **Discussions:** [github.com/FluxRelay/discussions](https://github.com/FluxRelay)
